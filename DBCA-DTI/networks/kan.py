...
def make_kans(input_dim, hidden_dim, output_dim, heads, hidden_layers, grid_size, spline_order):
    sizes = [input_dim] + [hidden_dim] * (hidden_layers - 2) + [output_dim]
    return MultiHeadKAN(layers_hidden=sizes, heads=heads, grid_size=grid_size, spline_order=spline_order)
